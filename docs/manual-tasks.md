...
| Add environment variables locally; never commit secrets. | Required for app/Supabase connection. | Future |
| Run migrations once created. | Required for database setup. | Future |
