        ...
        <section className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex flex-wrap gap-2">
              <Badge variant="secondary">Phase 6A</Badge>
            ...
            <p className="max-w-3xl text-lg leading-8 text-muted-foreground">
              Deck/card setup starts here with a game-specific draft deck shell,
              basic status, and placeholder manual-entry structure. This route
              does not include official card content, import files, deck
              locking, validation, or start-game behavior.
            </p>
          </div>
        </section>
